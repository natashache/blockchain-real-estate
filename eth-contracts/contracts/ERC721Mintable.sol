...
contract Ownable {
    ...
    modifier onlyOwner() {
        require(msg.sender == _owner, "The caller is not contract owner!");
        _;
    }
...
//  4) create 'whenNotPaused' & 'paused' modifier that throws in the appropriate situation
    modifier whenNotPaused() {
        require(_paused == false, "Contract needs to be NOT paused!");
        _;
    }
...
//    @dev Approves another address to transfer the given token ID
    function approve(address to, uint256 tokenId) public {
        ...
        emit Approval(_tOwner, to, tokenId);
    }
    ...
    function _mint(address to, uint256 tokenId) internal {
        ...
        require(!_exists(tokenId) && to != address(0), "Minting requirements not met!");
    ...
    function _transferFrom(address from, address to, uint256 tokenId) internal {
        ...
        // TODO: require token is being transferered to valid address
